...
$("#image-anther-1").hover(
    function(){  
        $(this).attr('src','images/work/anther-cardkits.jpeg');  
    },
    function(){  
        $(this).attr("src", "images/work/anther-cardkits-pixel.png");  
    }, 
);
$("#image-anther-2").hover(
    function(){  
        $(this).attr('src','images/work/anther-collages.jpeg');  
    },
    function(){  
        $(this).attr("src", "images/work/anther-collages-pixel.png");  
    }, 
);
$("#image-anther-3").hover(
    function(){  
        $(this).attr('src','images/work/Anther-surface.jpeg');  
    },
    function(){  
        $(this).attr("src", "images/work/anther-foreign-pixel.png");  
    }, 
);
...
$("#image-emi-1").hover(
    function(){  
        $(this).attr('src','images/work/emi-surplusdata.jpeg');  
    },
    function(){  
        $(this).attr("src", "images/work/emi-surplusdata-pixel.png");  
    }, 
);
$("#image-emi-2").hover(
function(){  
    $(this).attr('src','images/work/emi-wheeloffortune.jpeg');  
},
function(){  
    $(this).attr("src", "images/work/emi-wheeloffortune-pixel.png");  
}, 
);
$("#image-emi-3").hover(
function(){  
    $(this).attr('src','images/work/emi-jessamine.jpeg');  
},
function(){  
    $(this).attr("src", "images/work/emi-jessamine-pixel.png");  
}, 
);
